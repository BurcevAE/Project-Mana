...
VERSIONED_MODULES = (
    ...
    "core.cost", "core.instrument", "core.standing", "core.sequential",
    ...
    "cognition.laws", "cognition.lawgiver", "cognition.counterexamples",
    ...
    "cognition.chess_findings", "cognition.chess_outcome", "cognition.chess_version",
    "cognition.chess_watch", "net.aichess", "net.lichess", "cognition.findings", "cognition.series", "cognition.probes",
    ...
    "cognition.inquiry", "cognition.explain", "cognition.doubt",
    ...
    "discovery.cells", "discovery.derive", "discovery.frontier", "discovery.policy",
    "discovery.reflect", "discovery.selection", "discovery.ladder", "discovery.problems",
    "discovery.questions", "discovery.plans", "discovery.expressions", "discovery.prior",
    ...
    "apps.onec", "apps.onec_dataset", "apps.onec_launch", "apps.tools", "apps.chess_stand",
    "net.cli", "net.link", "net.peers",
